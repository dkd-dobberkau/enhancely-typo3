...
final class JsonLdResponse
{
    ...
    public function __toString(): string
    {
        ...
        // data-source mirrors the official enhancely/enhancely-php library so the
        // injected block stays identifiable across integrations. The library also
        // emits data-status and data-etag, but interpolates them unescaped — we
        // leave those out rather than reproduce the escaping gap.
        return '<script type="application/ld+json" data-source="Enhancely.ai">' . $encoded . '</script>';
    }
}
